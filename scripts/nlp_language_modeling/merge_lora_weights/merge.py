...
def main(cfg) -> None:
    ...
    # edited by Thanh
    if "llama3_1b" in cfg.gpt_model_file:
        model_config.tokenizer.model = '/home/dungdx4/BERT/Llama-3.2-1B/snapshots/model/original/tokenizer.model'
    # end editting
    with open_dict(cfg):
    ...
    print(f"LoRA config: {lora_model_cfg}")
